    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 mb-4">
                <form action="{{ route('contact.send') }}" method="POST" style="text-align: right;">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="ادخل رقم هاتفك">
                    </div>
                ...
                @if(session('success'))
                <div id="successPopupOverlay" style="position: fixed; top:0; left:0; width:100%; height:100%; background: rgba(0,0,0,0.5); display:flex; justify-content:center; align-items:center; z-index:1050;">
            ...
            <div class="col-md-6 mb-4 d-flex flex-column justify-content-between">
                <iframe 
                    ...
                    width="100%" 
                    style="flex-grow: 1; min-height: 92%; border:0;"
                    allowfullscreen="" 
                    loading="lazy">
                </iframe>

                <p style="margin-top: 15px;">شارع الأمير عبدالعزيز بن مساعد – حي الضباب – الرياض – المملكة العربية السعودية</p>
            </div>
